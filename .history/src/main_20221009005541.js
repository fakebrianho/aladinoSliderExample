...
const update = () => {
	...
	titleMaterial[0].uniforms.uVolatility.value = rngArr[0] + val
	titleMaterial[1].uniforms.uVolatility.value = rngArr[1] + val
	titleMaterial[2].uniforms.uVolatility.value = rngArr[2] + val
	titleMaterial[3].uniforms.uVolatility.value = rngArr[3] + val
	titleMaterial[4].uniforms.uVolatility.value = rngArr[4] + val
	titleMaterial[5].uniforms.uVolatility.value = rngArr[5] + val
